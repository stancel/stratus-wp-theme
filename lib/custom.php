...
function th_masterslider_update_check() {
    ...
    // revslider
    $th_plugin_dir = WP_PLUGIN_DIR . '/revslider';
    $th_plugin_slug = 'revslider';

    if ( is_dir( $th_plugin_dir ) ) {
        // plugin directory found!
        $myUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
            'https://import.themovation.com/live-plugin-updater/revslider.json',
...
function th_elementor_update_check() {
    ...
    // If PRO is installd, get updates directly from Elemenor REPO,
    // else, use our most recent tested version.
...
function th_register_required_plugins() {
	...
	$plugins = array(
        ...
        array(
            ...
            'source'    => 'https://www.dropbox.com/s/a46cxte7vfmm87o/groovy-menu.zip?dl=1', //get_template_directory() . '/plugins/th-widget-pack.zip', // The plugin source.
            'required' => false,
        ),
